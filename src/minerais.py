...
# campos = [coluna for coluna in dados if coluna != "geometry"]
...
# 			has_data = True
# 		properties['html_content'] = tooltip_content + "</div>" if has_data else ""
# 	feature = {
# 		"type": "Feature",
# 		"geometry": {
# 			"type": "Point",
...
# 	folium.GeoJson(
# 		dados,
# 		tooltip=folium.GeoJsonTooltip(fields=['html_content'], localize=False, sticky=True, permanent=False, style="background: black;font-size: 16px;"),
